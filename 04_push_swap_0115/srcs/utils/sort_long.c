...
/*   Updated: 2025/01/15 13:23:49 by layang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../push_swap.h"

void	first_push(t_list	**a, t_list	**b, t_push *push, int count)
{
	int	i;
...
void	quick_a(t_list	**a, t_list	**b, t_push	*push)
{
	int	count_b;
	int	i;
...
void quick_b(t_list	**a, t_list	**b, t_push	*push)
{
	int	cur_flag;
